 ...
 */
export declare const CONTEXT_TYPES: readonly ["workflow", "agent", "command", "code", "commit", "knowledge", "config", "doc", "tool_config"];
 ...
 * Supported AI tools
 */
export declare const AI_TOOLS: readonly ["claude", "copilot", "cline", "antigravity", "windsurf", "aider", "continue", "cursor", "gemini"];
export type AITool = typeof AI_TOOLS[number];
/**
 * AI tool folder mappings
 */
export declare const AI_TOOL_FOLDERS: Record<AITool, string[]>;
