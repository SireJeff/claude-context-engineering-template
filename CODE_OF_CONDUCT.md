...
* Publishing others' private information without explicit permission, such as a private email address or reports originating outside this project
...
Community leaders will follow these community impact guidelines to determine the appropriate action for any code-of-conduct violations:

### 1. Correction

**Community Impact**: A mistake was made, or a brief instance of acceptable behavior was used in an inappropriate context by a member in a project community setting.

**Consequence**: A private, written apology to those affected is required. No termination of account or removal from the project is required unless that termination or removal is requested by the reporting individual.

### 2. Warning

**Community Impact**: A repeated code of conduct violation, a more severe violation, or disbelief in warnings given in writing by community leaders.

**Consequence**: A written warning with clear expectations for future behavior. No termination of account or removal from the project is required unless that termination or removal is requested by the reporting individual.
