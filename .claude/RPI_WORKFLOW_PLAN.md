...
```
┌─────────────────────────────────────────────────────────┐
│ RPI-RESEARCH OUTPUT (Consumed by RPI-PLAN)              │
├─────────────────────────────────────────────────────────┤
│ CHUNK_MANIFEST:                                         │
│ ├── CHUNK-R1: API/Routes (status: COMPLETE)             │
│ │   ├── files: [list with :line refs]                   │
│ │   ├── dependencies: [internal/external]               │
│ │   └── ready_for_planning: true                        │
│ ├── CHUNK-R2: Business Logic (status: COMPLETE)         │
│ │   ├── files: [list with :line refs]                   │
│ │   ├── dependencies: [internal/external]               │
│ │   └── ready_for_planning: true                        │
│ └── CHUNK-Rn: ...                                       │
...
```
┌─────────────────────────────────────────────────────────┐
│ RPI-PLAN OUTPUT (Consumed by RPI-IMPLEMENT)             │
├─────────────────────────────────────────────────────────┤
│ CHUNK_MANIFEST:                                         │
│ ├── CHUNK-P1: (from CHUNK-R1) (status: READY)           │
│ │   ├── todolist: [ordered action items]                │
│ │   ├── tests: [per-todo test commands]                 │
│ │   ├── rollback: [chunk-specific rollback]             │
│ │   └── dependencies: [CHUNK-P2 depends on P1]          │
│ ├── CHUNK-P2: (from CHUNK-R2) (status: READY)           │
│ │   ├── todolist: [ordered action items]                │
│ │   ├── tests: [per-todo test commands]                 │
│ │   ├── rollback: [chunk-specific rollback]             │
│ │   └── dependencies: []                                │
...
### RESEARCH_TEMPLATE.md (Chunk-Aware)

See `.claude/research/RESEARCH_TEMPLATE.md` for the full chunk-aware template.

Key additions for inter-phase awareness:
- **Chunk Manifest Section** - Lists all chunks with IDs and status
- **Inter-Phase Contract** - Explicitly states what RPI-Plan expects
- **Per-Chunk Structure** - Each chunk is self-contained with files, deps, status

---

### PLAN_TEMPLATE.md (Chunk-Aware)

See `.claude/plans/PLAN_TEMPLATE.md` for the full chunk-aware template.

Key additions for inter-phase awareness:
- **Chunk-Todolist Section** - One todolist per research chunk
- **Inter-Phase Contract** - Explicitly states what RPI-Implement expects
- **Chunk Dependencies** - Explicit ordering requirements
- **Status Propagation** - How to update research document when complete
